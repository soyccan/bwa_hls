...
int bwa_align(
    ...
    const int cum[4], int refn, const char read[256], int readn);
# 2 "src/kernel.cpp" 2
...
# 1 "C:/Xilinx/Vivado/2019.2/win64/tools/clang/bin\\..\\lib\\clang\\3.1/../../../include/c++/4.5.2\\cstdio" 1 3
# 41 "C:/Xilinx/Vivado/2019.2/win64/tools/clang/bin\\..\\lib\\clang\\3.1/../../../include/c++/4.5.2\\cstdio" 3
# 41 "C:/Xilinx/Vivado/2019.2/win64/tools/clang/bin\\..\\lib\\clang\\3.1/../../../include/c++/4.5.2\\cstdio" 3
...
# 43 "C:/Xilinx/Vivado/2019.2/win64/tools/clang/bin\\..\\lib\\clang\\3.1/../../../include/c++/4.5.2\\cstdio" 2 3
...
# 44 "C:/Xilinx/Vivado/2019.2/win64/tools/clang/bin\\..\\lib\\clang\\3.1/../../../include/c++/4.5.2\\cstdio" 2 3
...
# 45 "C:/Xilinx/Vivado/2019.2/win64/tools/clang/bin\\..\\lib\\clang\\3.1/../../../include/c++/4.5.2\\cstdio" 2 3
# 92 "C:/Xilinx/Vivado/2019.2/win64/tools/clang/bin\\..\\lib\\clang\\3.1/../../../include/c++/4.5.2\\cstdio" 3
namespace std {
...
# 149 "C:/Xilinx/Vivado/2019.2/win64/tools/clang/bin\\..\\lib\\clang\\3.1/../../../include/c++/4.5.2\\cstdio" 3
namespace __gnu_cxx {
# 166 "C:/Xilinx/Vivado/2019.2/win64/tools/clang/bin\\..\\lib\\clang\\3.1/../../../include/c++/4.5.2\\cstdio" 3
  using ::snprintf;
  using ::vfscanf;
  using ::vscanf;
  using ::vsnprintf;
...
int bwa_align(
    ...
    const int occ[1024][4],
    const int cum[4], int refn, const char read[256], int readn)
{_ssdm_SpecArrayDimSize(res_sa_itv, 1024);_ssdm_SpecArrayDimSize(buf, 1024);_ssdm_SpecArrayDimSize(occ, 1024);_ssdm_SpecArrayDimSize(cum, 4);_ssdm_SpecArrayDimSize(read, 256);

_ssdm_SpecArrayPartition( read, 1, "COMPLETE", 0, "");
_ssdm_SpecArrayPartition( cum, 1, "COMPLETE", 0, "");
