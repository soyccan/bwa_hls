...
proc run_exec {fileExe} {
	...
	set ret [catch {eval exec "./$fileExe "G:\Repo\hls_project\data\ref\1.fasta.fmi" "G:\Repo\hls_project\data\reads\1.fastq" | tee tmp.log" >&@ stdout} err]
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "bwa_align.autotvin.dat"
	set constFileTvOut       "bwa_align.autotvout.dat"
	set constFileHdlTvIn     "bwa_align.autohdltvin.dat"
	set constFileHdlTvOut    "bwa_align.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
