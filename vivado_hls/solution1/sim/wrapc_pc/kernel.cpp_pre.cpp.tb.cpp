...
// ==============================================================
# 1 "G:/Repo/hls_project/src/kernel.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "G:/Repo/hls_project/src/kernel.cpp"
# 1 "G:/Repo/hls_project/src/kernel.h" 1
...
int bwa_align(
    ...
    const int cum[4], int refn, const char read[1024], int readn);
# 2 "G:/Repo/hls_project/src/kernel.cpp" 2

# 1 "G:/Repo/hls_project/src/utils.h" 1
...
# 42 "C:/Xilinx/Vivado/2019.2/tps/win64/msys64/mingw64/include/c++/6.2.0/cstdio" 2 3
...
# 43 "C:/Xilinx/Vivado/2019.2/tps/win64/msys64/mingw64/include/c++/6.2.0/cstdio" 2 3
...
# 5 "G:/Repo/hls_project/src/utils.h" 2
# 4 "G:/Repo/hls_project/src/kernel.cpp" 2


# 5 "G:/Repo/hls_project/src/kernel.cpp"
int bwa_align(
    int res_sa_itv[1024][2],
    int buf[1024][4],
